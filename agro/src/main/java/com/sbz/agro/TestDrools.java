...
public class TestDrools {
	...
	public static void main(String[] args) throws ClassNotFoundException, InterruptedException {
    	...
    	Reading r1 = new Reading(s12, DeviceReadingTypes.STATUS.name(), ReadingValues.ERROR.name(), new Date().getTime());
    	Reading r111 = new Reading(s12, DeviceReadingTypes.STATUS.name(), ReadingValues.ERROR.name(), new Date().getTime());
    	Reading ri = new Reading(v12, DeviceReadingTypes.STATUS.name(), ReadingValues.ERROR.name(), new Date().getTime());
    	Reading r2 = new Reading(s12, DeviceReadingTypes.STATUS.name(), ReadingValues.OK.name(), new Date().getTime());
    	Reading r3 = new Reading(s12, DeviceReadingTypes.STATUS.name(), ReadingValues.ERROR.name(), new Date().getTime());
    	Reading r4 = new Reading(s12, DeviceReadingTypes.STATUS.name(), ReadingValues.ERROR.name(), new Date().getTime());
    	Reading r5 = new Reading(s13, DeviceReadingTypes.STATUS.name(), ReadingValues.ERROR.name(), new Date().getTime());
    	Reading rPump = new Reading(pump1, DeviceReadingTypes.STATUS.name(), ReadingValues.ERROR.name(), new Date().getTime());
    	Reading rPumpOk = new Reading(pump1, DeviceReadingTypes.STATUS.name(), ReadingValues.OK.name(), new Date().getTime());
